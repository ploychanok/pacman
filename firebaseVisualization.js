...
const leftbox = parseInt(sessionStorage.getItem("left"));
const rightbox = parseInt(sessionStorage.getItem("right"));
const upbox = parseInt(sessionStorage.getItem("up"));
const downbox = parseInt(sessionStorage.getItem("down"));
